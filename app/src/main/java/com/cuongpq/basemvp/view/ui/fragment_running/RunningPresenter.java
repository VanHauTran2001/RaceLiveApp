...
//        }
        ...
        int round = carArrayList.get(position).getRound();
        if (round==1){
            sqLiteHelper.QueryData("UPDATE Car1 SET Round = '2',SS1 = '"+ RaceDetailsFragment.getTime() +"' WHERE IdCar = '" + idCar+ "' AND IdRace = '"+ idRace+"' ");
        }else if (round==2){
            sqLiteHelper.QueryData("UPDATE Car1 SET Round = '3',SS2 = '"+ RaceDetailsFragment.getTime() +"' WHERE IdCar = '" + idCar+ "' AND IdRace = '"+ idRace+"' ");
        }else if (round==3){
            sqLiteHelper.QueryData("UPDATE Car1 SET Round = '4',SS3 = '"+ RaceDetailsFragment.getTime() +"' WHERE IdCar = '" + idCar+ "' AND IdRace = '"+ idRace+"' ");
        }else if (round==4){
            sqLiteHelper.QueryData("UPDATE Car1 SET Round = '5',SS4 = '"+ RaceDetailsFragment.getTime() +"' WHERE IdCar = '" + idCar+ "' AND IdRace = '"+ idRace+"' ");
        }else if (round==5){
            sqLiteHelper.QueryData("UPDATE Car1 SET Round = '6',SS5 = '"+ RaceDetailsFragment.getTime() +"' WHERE IdCar = '" + idCar+ "' AND IdRace = '"+ idRace+"' ");
        }else if (round==6){
            sqLiteHelper.QueryData("UPDATE Car1 SET Round = '7',SS6 = '"+ RaceDetailsFragment.getTime() +"' WHERE IdCar = '" + idCar+ "' AND IdRace = '"+ idRace+"' ");
        }else if (round==7){
            sqLiteHelper.QueryData("UPDATE Car1 SET Round = '8',Stop = '"+ RaceDetailsFragment.getTime() +"' WHERE IdCar = '" + idCar+ "' AND IdRace = '"+ idRace+"' ");
        }else if (round==8){
            Toast.makeText(view.onGetContext(), "Finish", Toast.LENGTH_SHORT).show();
        }
    }
